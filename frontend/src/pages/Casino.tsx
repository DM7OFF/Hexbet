...
import { Dice5, Zap, Swords, Coins, Trophy, Spade, Bomb, TowerControl as Tower } from 'lucide-react';

const CASINO_GAMES = [
  { id: 'limbo', name: 'Limbo', icon: Zap, desc: 'Target a multiplier and win instantly.', houseEdge: '1.5%' },
  { id: 'dice', name: 'Provably Fair Dice', icon: Dice5, desc: 'Set your win chance. Instant payouts.', houseEdge: '1%' },
  { id: 'mines', name: 'Mines', icon: Bomb, desc: 'Find diamonds, avoid mines. High multipliers.', houseEdge: '1.5%' },
  { id: 'towers', name: 'Towers', icon: Tower, desc: 'Climb the tower for massive rewards.', houseEdge: '1.5%' },
